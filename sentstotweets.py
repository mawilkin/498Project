...
class sentstotweets:
    ...
    def __init__(self):
        self.ts = TwitterSearch(
            consumer_key = '1Aaf5dZwjcrioz80KWVwWg',
            consumer_secret = 'qBbCColesJQNauLMzZCT9lXEIevGlVA1f2xjfwdg',
            access_token = '277754799-Zm7HQbnFPA3QRLJL7kpqGheKZjU2mJMw5jxXgGfY',
    ...
    def top50Tweets(self):
        try:
            ...
            for sentiments in sentimentList:
                lst = []
                lst.append(sentiments)
                sentimentDic[sentiments] = []
                ...
                statuses = tweets['statuses'] #holds full data on tweet

                for i in range(len(statuses)):
                    sentimentDic[sentiments].append(statuses[i]['text'])
